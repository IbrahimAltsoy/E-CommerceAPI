...
namespace E_CommerceAPI.Persistance.Migrations
{
    ...
    [Migration("20231130162706_mig_CompletedOrders")]
    partial class mig_CompletedOrders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_CommerceAPI.Domain.Entities.BasketItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("E_CommerceAPI.Domain.Entities.CompletedOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("E_CommerceAPI.Domain.Entities.CompletedOrder", b =>
                {
                    b.HasOne("E_CommerceAPI.Domain.Entities.Order", "Order")
                        ...
                        .HasForeignKey("E_CommerceAPI.Domain.Entities.CompletedOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
